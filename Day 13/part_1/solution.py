...
def perform_folds(folding_instructions: list, coordinates: set, max_x: int, max_y: int, num_times: int):
    iterations = 0
...
new_coordinates, max_x, max_y = perform_folds(folding_instructions, dot_coordinates, max_x, max_y, 1)
