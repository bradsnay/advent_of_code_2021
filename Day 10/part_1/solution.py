...
def find_invalid_syntax(input_line: str) -> Union[str, None]:
    ...
    for char in input_line:
        ...
        if map_start_character_to_end_character[most_recent_starting_char] != char:
            return char
    return None
...
with open("input.txt", "r") as file:
    for line in file:
        ...
        if invalid_character is not None:
            scoring_dict[invalid_character] += scoring_map[invalid_character]
total_score = sum([score for score in scoring_dict.values()])
print(total_score)
